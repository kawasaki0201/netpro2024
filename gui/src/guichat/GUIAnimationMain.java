...
public class GUIAnimationMain extends JPanel implements ActionListener {
    ...
    public void setEyebrowAngle(int which, int angle) {
        System.out.println("setEyebrowAngle() : angle=" + angle);
        myBallRims[which].setEyebrowAngle(angle);
    }
